...
First you need to use the CreatePCAModel.py to create a model file.
"""
...
# Reconstruct face using mean face and EigenFaces
...
if __name__ == '__main__':
    ...
    cv2.createTrackbar("No. of EigenFaces", "Result", 0,
                       numEigenFaces, reconstructFace)
