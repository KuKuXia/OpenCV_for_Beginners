...
cv2.imshow("Image New Face", img2_new_face)
cv2.imshow("Image 2 Face Mask", img2_face_mask)
cv2.imshow("Image Head Noface", img2_head_noface)
cv2.imshow("Result", result)
cv2.imshow("Seamlessclone Result", seamlessclone)
