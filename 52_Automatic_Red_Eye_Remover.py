...
def fillHoles(mask):
    '''
        This hole filling algorithm is described in this post
...
if __name__ == '__main__':
    ...
    # Read image
    img = cv2.imread("./images/red_eyes.jpg", cv2.IMREAD_COLOR)

    # Output image
    imgOut = img.copy()

    # Load HAAR cascade
    eyesCascade = cv2.CascadeClassifier("./images/haarcascade_eye.xml")
    ...
    for (x, y, w, h) in eyes:
        ...
        mask = fillHoles(mask)
        mask = cv2.dilate(mask, None, anchor=(-1, -1),
